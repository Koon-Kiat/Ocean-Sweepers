...
import project.game.application.movement.AcceleratedMovementStrategy;
import project.game.application.movement.ConstantMovementStrategy;
import project.game.application.movement.FollowMovementStrategy;
import project.game.application.movement.InterceptorMovementStrategy;
import project.game.application.movement.ObstacleAvoidanceStrategy;
import project.game.application.movement.OrbitalMovementStrategy;
import project.game.application.movement.RandomisedMovementStrategy;
import project.game.application.movement.SpiralApproachStrategy;
import project.game.application.movement.SpringFollowStrategy;
import project.game.application.movement.ZigZagMovemenStrategy;
